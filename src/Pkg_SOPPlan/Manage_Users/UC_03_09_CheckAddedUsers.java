...
public class UC_03_09_CheckAddedUsers {

	public static void main(String[] args) throws InterruptedException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "03_Manage_Users";
		cl.testCaseName = "UC_03_09_CheckAddedUsers";
		cl.tableName = "tbl_manage_users";
		cl.useCaseName = "UC_03_09_CheckAddedUsers";
		cl.readXML();
		cl.loadTestData();
...
//		Check added users in data table
		...
		//For direct login only stop the execution
		if(cl.isLoginRequired.equals("YES"))
		{
			cl.exitCurrentTest();
		}
