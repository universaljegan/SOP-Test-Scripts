...
public class UC_03_37_ClearAllData {

	public static void main(String[] args) throws InterruptedException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "03_Manage_Users";
		cl.testCaseName = "UC_03_37_ClearAllData";
		cl.tableName = "tbl_manage_users";
		cl.useCaseName = "UC_03_37_ClearAllData";
		cl.readXML();
		cl.loadTestData();
		...
		cl.executeTestStep("mus_clear_all", "click");
		
		commonLibrary.curTableRow = "1";
		cl.executeTestStep("mus_email_error", "notexist");

		commonLibrary.curTableRow = "2";
		cl.executeTestStep("mus_first_name_error", "notexist");
		cl.executeTestStep("mus_email_error", "notexist");
