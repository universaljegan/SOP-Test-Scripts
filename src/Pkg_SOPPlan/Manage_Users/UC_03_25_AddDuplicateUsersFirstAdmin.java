...
public class UC_03_25_AddDuplicateUsersFirstAdmin {

	public static void main(String[] args) throws InterruptedException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "03_Manage_Users";
		cl.testCaseName = "UC_03_25_AddDuplicateUsersFirstAdmin";
		cl.tableName = "tbl_manage_users";
		cl.useCaseName = "UC_03_25_AddDuplicateUsersFirstAdmin";
		cl.readXML();
		cl.loadTestData();
		...
		cl.clickAlert("ok");
		Thread.sleep(2000);
		cl.validateAlert("Errors have been found in the data, Please correct these and try again");
		Thread.sleep(2000);		
		cl.clickAlert("ok");
		Thread.sleep(2000);	
