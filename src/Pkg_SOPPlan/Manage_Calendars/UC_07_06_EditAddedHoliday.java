...
public class UC_07_06_EditAddedHoliday {

	public static void main(String[] args) throws InterruptedException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "07_Manage_Calendar";
		cl.testCaseName = "UC_07_06_EditAddedHoliday";
		cl.tableName = "tbl_manage_calendar";
		cl.useCaseName = "UC_07_06_EditAddedHoliday";
		cl.readXML();
		cl.loadTestData();
		...
		cl.tableValidationStatic("ctl00_ContentMenu_gvEditHolidays_ctl", "_txtHolidayName", "02", "ctl00_ContentMenu_gvEditHolidays", "mcl_holiday_name", "mcl_holiday_edit_after_one_year", "setValue", "ctl00_ContentMenu_gvEditHolidays_ctl", "_ccOneYearAfter_txtDate");
