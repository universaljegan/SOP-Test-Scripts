...
public class UC_09_06_ValidateErrorsInMail {

	public static void main(String[] args) throws InterruptedException, AWTException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "09_Upload_Sales_History";
		cl.testCaseName = "UC_09_06_ValidateErrorsInMail";
		cl.tableName = "tbl_upload_sales_history";
		cl.useCaseName = "UC_09_06_ValidateErrorsInMail";
		cl.readXML();
		cl.loadTestData();
...
//		cl.executeTestStep("aac_activation_link_new_forecasting_system", "click");
		...
		cl.mpc_excel_upload_error_validation_in_mail("5", "2", "Sales history cannot be future date, Please remove all Future Dates.");
		cl.mpc_excel_upload_error_validation_in_mail("6", "2", "Sales history cannot be future date, Please remove all Future Dates.");
		cl.mpc_excel_upload_error_validation_in_mail("7", "2", "No product number");
		cl.mpc_excel_upload_error_validation_in_mail("8", "2", "No customer");
		cl.mpc_excel_upload_error_validation_in_mail("9", "2", "Data not in numeric format");
		cl.mpc_excel_upload_error_validation_in_mail("10", "2", "Product number not recognized");
		cl.mpc_excel_upload_error_validation_in_mail("11", "2", "Customer not recognized");
		cl.mpc_excel_upload_error_validation_in_mail("12", "2", "Sales history cannot have a negative value");
		cl.mpc_excel_upload_error_validation_in_mail("13", "2", "No customer");
		cl.mpc_excel_upload_error_validation_in_mail("14", "2", "Duplicated Product / customer");
