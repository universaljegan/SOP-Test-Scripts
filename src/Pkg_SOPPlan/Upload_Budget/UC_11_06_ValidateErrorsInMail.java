...
public class UC_11_06_ValidateErrorsInMail {

	public static void main(String[] args) throws InterruptedException, AWTException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "11_Upload_Budget_Target";
		cl.testCaseName = "UC_11_06_ValidateErrorsInMail";
		cl.tableName = "tbl_upload_buget_target";
		cl.useCaseName = "UC_11_06_ValidateErrorsInMail";
		cl.readXML();
		cl.loadTestData();
		...
		//		Last use case was Review forecast, so navigate menu is mandatory
...
//		Thread.sleep(3000);
//		
//		cl.executeTestStep("upl_open_upload_budget_error_mail", "click");
...
//		cl.mpc_excel_upload_error_validation_in_mail("10", "2", "Sales history cannot have a negative value");
