...
public class UC_11_04_UploadWithErrors {

	public static void main(String[] args) throws InterruptedException, AWTException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "11_Upload_Budget_Target";
		cl.testCaseName = "UC_11_04_UploadWithErrors";
		cl.tableName = "tbl_upload_buget_target";
		cl.useCaseName = "UC_11_04_UploadWithErrors";
		cl.readXML();
		cl.loadTestData();
...
//		cl.clickAlert("ok");
		...
		cl.mpc_excel_upload_error_validation_sales_history("7", "2", "Cannot have a negative value");
