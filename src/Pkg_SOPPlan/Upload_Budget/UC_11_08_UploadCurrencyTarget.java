...
public class UC_11_08_UploadCurrencyTarget {

	public static void main(String[] args) throws InterruptedException, AWTException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "11_Upload_Budget_Target";
		cl.testCaseName = "UC_11_08_UploadCurrencyTarget";
		cl.tableName = "tbl_upload_buget_target";
		cl.useCaseName = "UC_11_08_UploadCurrencyTarget";
		cl.readXML();
		cl.loadTestData();
		...
		cl.executeTestStep("upl_budget_target_data", "select");
		cl.executeTestStep("upl_unit_currency", "select");
...
//		Thread.sleep(3000);
//		
//		String expectedText = "We are pleased to advise you that your Sales forecast data was correctly uploaded to MYSOPPLAN.com Your uploaded file name is :SOPPLAN_sales_forecast_upload_10_07.csv";
//		
