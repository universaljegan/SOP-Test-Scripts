...
public class UC_10_08_UploadHistoricalForecastWithErrors {

	public static void main(String[] args) throws InterruptedException, AWTException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "10_Upload_Sales_Forecast";
		cl.testCaseName = "UC_10_08_UploadHistoricalForecastWithErrors";
		cl.tableName = "tbl_upload_sales_forecast";
		cl.useCaseName = "UC_10_08_UploadHistoricalForecastWithErrors";
		cl.readXML();
		cl.loadTestData();
		...
		cl.mpc_excel_upload_error_validation_sales_history("7", "2", "First horizon cannot have a negative value");
