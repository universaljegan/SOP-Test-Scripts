...
public class UC_10_06_ValidateErrorsInMail {

	public static void main(String[] args) throws InterruptedException, AWTException {
		commonLibrary cl = new commonLibrary();
		cl.packageName = "10_Upload_Sales_Forecast";
		cl.testCaseName = "UC_10_06_ValidateErrorsInMail";
		cl.tableName = "tbl_upload_sales_forecast";
		cl.useCaseName = "UC_10_06_ValidateErrorsInMail";
		cl.readXML();
		cl.loadTestData();
...
//		cl.executeTestStep("aac_activation_link_new_forecasting_system", "click");
		...
		cl.mpc_excel_upload_error_validation_in_mail("10", "2", "Sales forecast cannot have a negative value");
